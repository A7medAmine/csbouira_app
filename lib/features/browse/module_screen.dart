              ...
              children: [
                ...
                Expanded(
                  child: nodeAsync.when(
                    ...
                    data: (node) {
                      if (node == null) return const Center(child: Text('No modules found'));
                      final allModules = node.subfolders.entries.where((e) {
                        return e.key != 'Books & Exercices';
                      }).toList();
                      final filtered = _query.isEmpty
                          ? allModules
                          : allModules.where((e) =>
                              e.key.toLowerCase().contains(_query.toLowerCase())).toList();
                      if (allModules.isEmpty) {
                        return const Center(child: Text('No modules available'));
                      }

                      final totalFiles = allModules.fold<int>(0, (sum, e) => sum + e.value.totalFiles);
                        ...
                        children: [
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    _query.isEmpty ? 'All Modules' : 'Search Results',
                                    style: theme.textTheme.headlineMedium?.copyWith(
                                      color: Colors.white,
                                    ),
                                  ),
                          ...
                          if (filtered.isEmpty)
                            ...
                            ...filtered.map((entry) {
                              ...
                              final folCount = entry.value.subfolders.length;
