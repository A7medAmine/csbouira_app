...
class AppLocalizationsAr extends AppLocalizations {
  ...
  @override
  String get authErrorNetwork => 'مشكلة في الاتصال. تحقق من اتصالك بالإنترنت وحاول مرة اخرى.';

  @override
  String get authErrorGeneric => 'حدث خطأ ما. يرجى المحاولة مرة اخرى بعد قليل.';
  ...
  String updateBannerDownloading(Object progress) {
    return 'جاري تحميل التحديث... $progress%';
  }

  @override
  String get updateBannerReady => 'تم تحميل التحديث. انقر للتثبيت.';
  ...
  @override
  String get aboutCheckingUpdate => 'جاري التحقق من وجود تحديثات...';
